...
export default class Authenticator {
   ...
   * @param {String} webIntegrationId - your web Integration Id from managment console
   ...
   * gets you the promise of enigma instance for your app
   * based on clientId
   * @param {String} clientId     - your client Id from managment console
   * @param {String} redirectUri  - the redirect url while bringing you the code + state, default is `window.location.origin`
   * @returns {Promise<IEnigmaClass>} enigma app promise
   */
